...
uses
    ...
    UnivDisasm.Cnsts.Instructions
      in 'Common\UnivDisasm\UnivDisasm.Cnsts.Instructions.pas',
    UnivDisasm.Cnsts.Mnemonics
      in 'Common\UnivDisasm\UnivDisasm.Cnsts.Mnemonics.pas',
    ...
    UnivDisasm.Internal.Common
      in 'Common\UnivDisasm\UnivDisasm.Internal.Common.pas',
    UnivDisasm.Internal.Escape
      in 'Common\UnivDisasm\UnivDisasm.Internal.Escape.pas',
    UnivDisasm.Internal.Prefixes
      in 'Common\UnivDisasm\UnivDisasm.Internal.Prefixes.pas',
    UnivDisasm.Syntax.NilSyntax
      in 'Common\UnivDisasm\UnivDisasm.Syntax.NilSyntax.pas',
    UnivDisasm.Syntax.UnivSyntax
      in 'Common\UnivDisasm\UnivDisasm.Syntax.UnivSyntax.pas',
    UnivDisasm.Syntax.Utils in 'Common\UnivDisasm\UnivDisasm.Syntax.Utils.pas',
    UnivDisasm.SyntaxManager
      in 'Common\UnivDisasm\UnivDisasm.SyntaxManager.pas',
